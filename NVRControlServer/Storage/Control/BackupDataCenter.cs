...
namespace NVRControlServer.Storage.Control
{
    public class BackupDataCenter 
    {
        ...
        {
            int backupVideoLength = Convert.ToInt32(dataoperate.ReadString("BackupSet", "BackupVideoLength", "", autoBackupfigFile));
            ...
            while (true)
            {
                ...
                //{
                    ...
                    DateTime startTime = TimeHelper.StringToDateTime(
                       dataoperate.ReadString(nvrList[1].NvrName, nvrChannels[0].ChannelIndex.ToString() + "startTime", "", autoBackupfigFile));
                    DateTime lastTime = TimeHelper.StringToDateTime(
                        dataoperate.ReadString(nvrList[1].NvrName, nvrChannels[0].ChannelIndex.ToString() + "lastTime", "", autoBackupfigFile));
                    DateTime backupTime = TimeHelper.StringToDateTime(
                        dataoperate.ReadString(nvrList[1].NvrName, nvrChannels[0].ChannelIndex.ToString() + "backupTime", "", autoBackupfigFile));
                    ...
                    //{
                        ...
                        BuckupTaskParameter taskParameter =
                            new BuckupTaskParameter(1, 0, backupVideoLength, 2, nvrcontroler,
